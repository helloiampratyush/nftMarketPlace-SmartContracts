...
declare type ErrorCallback = (err: Error | null, data?: any) => void;
declare type Callback = () => void;
declare type OnNextCompleted = (err: Error | null, result: any, cb: Callback) => void;
declare type NextCallback = (callback?: OnNextCompleted) => void;
