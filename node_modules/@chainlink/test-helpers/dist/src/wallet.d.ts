 ...
 */
export declare function fundWallet(wallet: ethers.Wallet, provider: ethers.providers.JsonRpcProvider, overrides?: Omit<ethers.providers.TransactionRequest, 'to' | 'from'>): Promise<ethers.providers.TransactionReceipt | undefined>;
export {};
